  ...
  return (
    <div style={{marginTop:'70px', minHeight:'100vh'}}>
      ...
      <div className='container text-center col-10 mb-4'>
        <p style={{ fontSize: '1.5em' }}>Hello! Thank you for visiting our web site and using our services to make such an important decision in your life. We do our best to provide you all the tools to make it smooth and enjoyable.</p>
        <div>
